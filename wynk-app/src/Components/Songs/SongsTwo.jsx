...
const SongsTwo = () => {
    ...
    return (
        // <>
        //     <div className='title'>NewYear Special</div>
        //     <div className="a1"><a>More</a></div>
        //     <div className='main-container'>
        //         <Slide {...proprietes}>
        //             <div className='slide-image'>
        //                 {/* <a className="a1">More</a> */}
        //                 <img className='img' src="https://static.toiimg.com/photo/msid-81648613/81648613.jpg" alt="first"></img>
